...
mongoose.connect("mongodb+srv://" + process.env.M_LOG + ":" + process.env.M_PASS + "@cluster0-dq8rc.mongodb.net/test?retryWrites=true&w=majority", { useNewUrlParser: true, useUnifiedTopology: true });
app.use(morgan("dev"))
